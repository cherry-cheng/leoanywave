...
import com.anywave.qpop.activity.MyEvent;
            ...
            try {
               ...
               // System.out.println("leo1 openwifi");
                ...
                if (tempConfig != null) {
                    ...
                    System.out.println("sara2 enableNetwork ssid = "+ tempConfig.networkId + " enable = " + b + " wifistate = " + (wifiState==WifiManager.WIFI_STATE_ENABLED));
                    ...
                    System.out.println("sara enableNetwork ssid = "+ wifiConfig.SSID + " enable = " + enabled );
                    boolean connected = wifiManager.reconnect();
                    System.out.println("sara wifiManager.reconnect() : " + connected);
