...
//   cal.setTime(new Date(System.currentTimeMillis()));
    ...
    public static boolean isWifi(String wifistr) {
        ...
        String wifi1 = App.context.getString(R.string.wifi1);
        String wifi2 = App.context.getString(R.string.wifi2);

    //    System.out.println("leo3 wifistr = " + wifistr);
        return wifistr.toLowerCase().contains(wifi1.toLowerCase()) || wifistr.toLowerCase().contains(wifi2.toLowerCase());
    }
