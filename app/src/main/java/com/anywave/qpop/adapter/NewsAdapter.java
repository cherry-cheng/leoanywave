...
import com.anywave.qpop.activity.DialogDeleteActivity;
    ...
    private void getDetail(int id, String date) {
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String arg0) {
                ...
                HkList hkList = new Gson().fromJson(arg0, HkList.class);
                List<HkList.DataBeanX.DataBean> dataBeen = hkList.getData().getData();
