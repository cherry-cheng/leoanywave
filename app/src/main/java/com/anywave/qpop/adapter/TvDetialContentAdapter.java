...
public class TvDetialContentAdapter extends RecyclerView.Adapter<TvDetialContentAdapter.DetialContentViewHolder> {
...
//        backLockMap = new HashMap<>();
    ...
    public TvDetialContentAdapter(){

    }

    public TvDetialContentAdapter(Context context, final List<HkList.DataBeanX.DataBean> dataBeen, final int currentDay, LinearLayoutManager layoutManager) {
            ...
            viewHolder.tvBackLock.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (App.isClicked) {
                        ...
                        if (LiveDetailActivity.mNiceVideoPlayer!=null
                                &&LiveDetailActivity.mNiceVideoPlayer.mController!=null) {
